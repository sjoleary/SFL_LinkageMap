...
FamB_F.f1B <- subset(FamB_F.f1A, ind = (ntyped(FamB_F.f1A) > Nloci_F.f1A*0.95))
...
for (chr in c(8, 13, 17, 19, 21, 24:25, 27, 29:31,
              33, 35:39, 41:48)){
...
FamB_F.LP <- drop.markers(FamB_F.LP, c("dDocent_Contig_166471", "dDocent_Contig_99420"))
...
FamB_F.LP <- drop.markers(FamB_F.LP, "dDocent_Contig_305002")
...
FamB_F.final <- drop.markers(FamB_F.final, "dDocent_Contig_169912") # LG24
FamB_F.final <- drop.markers(FamB_F.final, "dDocent_Contig_138502") # LG23
FamB_F.final <- drop.markers(FamB_F.final, "dDocent_Contig_156439") # LG22
FamB_F.final <- drop.markers(FamB_F.final, "dDocent_Contig_48243") # LG21
FamB_F.final <- drop.markers(FamB_F.final, "dDocent_Contig_344840") # LG21
FamB_F.final <- drop.markers(FamB_F.final, "dDocent_Contig_277952") # LG20
FamB_F.final <- drop.markers(FamB_F.final, "dDocent_Contig_36576") # LG19
FamB_F.final <- drop.markers(FamB_F.final, "dDocent_Contig_46435") # LG17
FamB_F.final <- drop.markers(FamB_F.final, "dDocent_Contig_141878") # LG15
FamB_F.final <- drop.markers(FamB_F.final, "dDocent_Contig_82981") # LG15
FamB_F.final <- drop.markers(FamB_F.final, "dDocent_Contig_11655") # LG14
FamB_F.final <- drop.markers(FamB_F.final, "dDocent_Contig_41004") # LG13
FamB_F.final <- drop.markers(FamB_F.final, "dDocent_Contig_123865") # LG12
FamB_F.final <- drop.markers(FamB_F.final, "dDocent_Contig_331600") # LG11
FamB_F.final <- drop.markers(FamB_F.final, "dDocent_Contig_11361") # LG10
FamB_F.final <- drop.markers(FamB_F.final, "dDocent_Contig_102279") # LG7
FamB_F.final <- drop.markers(FamB_F.final, "dDocent_Contig_307315") # LG6
FamB_F.final <- drop.markers(FamB_F.final, "dDocent_Contig_49942") # LG5
FamB_F.final <- drop.markers(FamB_F.final, "dDocent_Contig_2088") # LG4
FamB_F.final <- drop.markers(FamB_F.final, "dDocent_Contig_233139") # LG3
FamB_F.final <- drop.markers(FamB_F.final, "dDocent_Contig_166471") # LG25
FamB_F.final <- drop.markers(FamB_F.final, "dDocent_Contig_99420") # LG25
FamB_F.final <- drop.markers(FamB_F.final, "dDocent_Contig_18025") # LG26
FamB_F.final <- drop.markers(FamB_F.final, "dDocent_Contig_285352") # LG27
FamB_F.final <- drop.markers(FamB_F.final, "dDocent_Contig_305002") # LG28
...
# drop markers (LOD more positive, larger diff in likelihood) 
FamB_F.final <- drop.markers(FamB_F.final, "dDocent_Contig_170530") # LG17
FamB_F.final <- drop.markers(FamB_F.final, "dDocent_Contig_78213") # LG13
FamB_F.final <- drop.markers(FamB_F.final, "dDocent_Contig_20649") # LG12
FamB_F.final <- drop.markers(FamB_F.final, "dDocent_Contig_46457") # LG12
FamB_F.final <- drop.markers(FamB_F.final, "dDocent_Contig_4997") # LG11
FamB_F.final <- drop.markers(FamB_F.final, "dDocent_Contig_101552") # LG11
FamB_F.final <- drop.markers(FamB_F.final, "dDocent_Contig_110111") # LG9
FamB_F.final <- drop.markers(FamB_F.final, "dDocent_Contig_138814") # LG9
FamB_F.final <- drop.markers(FamB_F.final, "dDocent_Contig_31799") # LG9
FamB_F.final <- drop.markers(FamB_F.final, "dDocent_Contig_125611") # LG8
FamB_F.final <- drop.markers(FamB_F.final, "dDocent_Contig_237691") # LG8
FamB_F.final <- drop.markers(FamB_F.final, "dDocent_Contig_269651") # LG5
FamB_F.final <- drop.markers(FamB_F.final, "dDocent_Contig_2072") # LG3
FamB_F.final <- drop.markers(FamB_F.final, "dDocent_Contig_22529") # LG3
FamB_F.final <- drop.markers(FamB_F.final, "dDocent_Contig_318298") # LG1
...
```{r}
# use plot to identify chromosomes to switch alleles for
for (chr in c(9, 11, 17, 19, 21, 23:24, 29:34,
              26, 38:41, 43:48)){
  toswitch <- markernames(FamB_M.LP, chr=(chr))
  FamB_M.LP <- switchAlleles(FamB_M.LP, toswitch)
}

pull.map(FamB_M.LP, chr="49")
pull.map(FamB_M.LP, chr="50")
FamB_M.LP <- drop.markers(FamB_M.LP, c("dDocent_Contig_153642", "dDocent_Contig_320958"))
