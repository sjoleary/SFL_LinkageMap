...
```{r}
# use plot to identify chromosomes to switch alleles for
for (chr in c(5, 6, 17:18, 20, 24:25, 28:32, 36:43,
              46:49)){
...
# drop markers (LOD more positive, larger diff in likelihood)
FamB_M.final <- drop.markers(FamB_M.final, "dDocent_Contig_9683") # LG24
FamB_M.final <- drop.markers(FamB_M.final, "dDocent_Contig_101552") # LG19
FamB_M.final <- drop.markers(FamB_M.final, "dDocent_Contig_262954") # LG18
FamB_M.final <- drop.markers(FamB_M.final, "dDocent_Contig_2755") # LG17
FamB_M.final <- drop.markers(FamB_M.final, "dDocent_Contig_16344") # LG16
FamB_M.final <- drop.markers(FamB_M.final, "dDocent_Contig_63665") # LG14
FamB_M.final <- drop.markers(FamB_M.final, "dDocent_Contig_189129") # LG14
FamB_M.final <- drop.markers(FamB_M.final, "dDocent_Contig_130341") # LG13
FamB_M.final <- drop.markers(FamB_M.final, "dDocent_Contig_112900") # LG10
FamB_M.final <- drop.markers(FamB_M.final, "dDocent_Contig_14518") # LG10
FamB_M.final <- drop.markers(FamB_M.final, "dDocent_Contig_119334") # LG10
FamB_M.final <- drop.markers(FamB_M.final, "dDocent_Contig_299810") # LG8
FamB_M.final <- drop.markers(FamB_M.final, "dDocent_Contig_49325") # LG7
FamB_M.final <- drop.markers(FamB_M.final, "dDocent_Contig_83367") # LG6
FamB_M.final <- drop.markers(FamB_M.final, "dDocent_Contig_397758") # LG5
FamB_M.final <- drop.markers(FamB_M.final, "dDocent_Contig_5352") # LG5
...
write.table(indXO_BF, "data/LINKMAP/FamB_M.XO",
            col.names = TRUE, quote = FALSE)
...
# drop markers (LOD more positive, larger diff in likelihood) 
FamB_M.final <- drop.markers(FamB_M.final, "dDocent_Contig_99384") # LG17
FamB_M.final <- drop.markers(FamB_M.final, "dDocent_Contig_33552") # LG5
FamB_M.final <- drop.markers(FamB_M.final, "dDocent_Contig_36948") # LG5
FamB_M.final <- drop.markers(FamB_M.final, "dDocent_Contig_10430") # LG5
FamB_M.final <- drop.markers(FamB_M.final, "dDocent_Contig_8540") # LG5
...
Onemap.filtered <- semi_join(FamB.onemap, mapped_markers) %>%
  filter(!LOCUS %in% c("*dDocent_Contig_15848",
                       "*dDocent_Contig_12831",
                       "*dDocent_Contig_50281",
                       "*dDocent_Contig_131658",
                       "*dDocent_Contig_26999",
                       "*dDocent_Contig_2517",
                       "*dDocent_Contig_6811",
                       "*dDocent_Contig_5465",
                       "*dDocent_Contig_41762",
                       "*dDocent_Contig_49203",
                       "*dDocent_Contig_20038",
                       "*dDocent_Contig_15457",
                       "*dDocent_Contig_19289",
                       "*dDocent_Contig_21587",
                       "*dDocent_Contig_29713",
                       "*dDocent_Contig_179212",
                       "*dDocent_Contig_171172",
                       "*dDocent_Contig_10181",
                       "*dDocent_Contig_22869",
                       "*dDocent_Contig_91516",
                       "*dDocent_Contig_16668",
                       "*dDocent_Contig_13707",
                       "*dDocent_Contig_132810",
                       "*dDocent_Contig_98489",
                       "*dDocent_Contig_30292",
                       "*dDocent_Contig_37810",
                       "*dDocent_Contig_216791",
                       "*dDocent_Contig_24183"))
