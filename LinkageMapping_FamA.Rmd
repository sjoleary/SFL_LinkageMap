...
FamA_F.map <- read.table("results/FamA_F.map", 
                         header = TRUE, stringsAsFactors = FALSE)

FamA_M.map <- read.table("results/FamA_M.map", 
                         header = TRUE, stringsAsFactors = FALSE)
...
# print output
write.table(marker.all, file = "results/FamA.allmarkers",
...
# plot with ggplot
ggplot(FamA_F.map, aes(x = LG_F, y = POS_F)) +
  ...
  labs(x = "\nLinkage Group Fam A female", y = "Position (cM)\n") +
  theme_classic() +
...
# plot with ggplot
ggplot(FamA_M.map, aes(x = LG_M, y = POS_M)) +
  ...
  #                   labels=c("EST-SSR", "Microsatellite", "RAD Locus"),
  #                   values=c('#9e0142', '#a1d99b', '#2b8cbe') +
  labs(x = "\nLinkage Group Fam A male", y = "Position (cM)\n") +
  theme_classic() +
  theme(axis.title = element_text(size = 16),
        axis.title.y = element_text(vjust = 1.5),
        axis.line.x = element_blank(),
...
# read map data
FamA.map <- read.table("results/FamA_family.map", 
                         header = TRUE, stringsAsFactors = FALSE)
...
ggplot(FamA.map, aes(x = LG, y = POSITION)) +
  ...
  #                   labels=c("EST-SSR", "Microsatellite", "RAD Locus"),
  #                   values=c('#9e0142', '#a1d99b', '#2b8cbe') +
  labs(x = "\nLinkage Group Fam A", y = "Position (cM)\n") +
  theme_classic() +
  theme(axis.title = element_text(size = 16),
        axis.title.y = element_text(vjust = 1.5),
        axis.line.x = element_blank(),
