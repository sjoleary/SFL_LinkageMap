...
# write karyotype track file
write.table(kary, "data/SYNTENY/poli.karyotype.txt",
            sep = "\t", quote = FALSE, row.names = FALSE, col.names = FALSE)
...
# write karyotype track file
write.table(kary, "data/SYNTENY/csem.karyotype.txt",
            sep = "\t", quote = FALSE, row.names = FALSE, col.names = FALSE)
...
write.table(dlab_synblocks, file = "data/SYNTENY/poli.syn", 
                         sep = "\t", quote = FALSE, row.names = FALSE, col.names = FALSE)
...
write.table(dlab_synblocks, file = "data/SYNTENY/csem.syn", 
                         sep = "\t", quote = FALSE, row.names = FALSE, col.names = FALSE)
