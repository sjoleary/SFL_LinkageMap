...
write.table(kary, file = "data/SYNTENY/SFL_karyotype.txt", 
            sep = "\t", quote = FALSE, 
...
write.table(kary, "data/SYNTENY/dlab_karyotype.txt",
...
# write karyotype track file
write.table(kary, "data/SYNTENY/gacu_karyotype.txt",
            sep = "\t", quote = FALSE, row.names = FALSE, col.names = FALSE)
...
# write karyotype track file
write.table(kary, "data/SYNTENY/lcal_karyotype.txt",
            sep = "\t", quote = FALSE, row.names = FALSE, col.names = FALSE)
...
# write karyotype track file
write.table(kary, "data/SYNTENY/onil_karyotype.txt",
            sep = "\t", quote = FALSE, row.names = FALSE, col.names = FALSE)
...
# write karyotype track file
write.table(kary, "data/SYNTENY/tnig_karyotype.txt",
            sep = "\t", quote = FALSE, row.names = FALSE, col.names = FALSE)
...
# write karyotype track file
write.table(kary, "data/SYNTENY/trub_karyotype.txt",
            sep = "\t", quote = FALSE, row.names = FALSE, col.names = FALSE)
...
for (i in 1:length(species)) {
    ...
    write.table(tiles, file = paste("data/SYNTENY/", species[i], ".txt", sep = ''), 
                sep = "\t", quote = FALSE, 
                row.names = FALSE, col.names = FALSE)
}
...
write.table(syn_loci, file = "data/SYNTENY/syn_loci.txt", 
            sep = "\t", quote = FALSE, 
            row.names = FALSE, col.names = FALSE)
```
...
write.table(dlab_synblocks, file = "data/SYNTENY/dlab_synteny.txt", 
                         sep = "\t", quote = FALSE, row.names = FALSE, col.names = FALSE)
...
system('perl "scr/circos-0.66/bin/circos" -conf data/SYNTENY/circos-synt_comp.conf -outputdir fig -outputfile synteny-comp')
